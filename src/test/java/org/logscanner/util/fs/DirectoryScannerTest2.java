...
/**
 * Tests for original {@link org.apache.tools.ant.DirectoryScanner}
 */
public class DirectoryScannerTest2 {
    ...
    {
    	DirectoryScanner result = new DirectoryScanner();
//    	result.setHost("127.0.0.1");
//    	result.setUser("victor");
//    	result.setPassword("1qaz2wsx");
	...
	@Test
    public void test1() {
		DirectoryScanner ds = createDirectoryScanner();
